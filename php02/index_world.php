...
//２．データ登録SQL作成
$stmt = $pdo->prepare("SELECT * FROM ec2_table where country like '%ワールドウィスキー%'");
...
<body>
  <header class="header">
    ...
    <a href="" class="btn btn-menu">TOPページ</a>
  </header>
      ...
      <aside class="sidebar">
        ...
        <div class="widget">
          ...
          <ul class="category-list">
            ...
            <li class="category-item"><a href="./index_world.php">ワールドウィスキー</a></li>
          </ul>
        </div>
        <!--end category-->
      </aside>
