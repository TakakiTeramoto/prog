...
<body class="cms">
  ...
  <div class="outer">
    ...
    <div class="wrapper wrapper-cms">
      ...
      <!-- 画像送信のときに必要:enctype="multipart/form-data" -->
        <!--商品情報-->
        ...
        <dl class="cms-list">
          ...
          <dt>原産国</dt>
          <dd><input type="text" name="country" placeholder="原産国を入力" class="cms-item"></dd>
          <dt>カテゴリー</dt>
          <dd><input type="text" name="category" placeholder="ウィスキーの種類を入力" class="cms-item"></dd>
          <dt>金額</dt>
